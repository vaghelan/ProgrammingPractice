...
class TestProgram(unittest.TestCase):
    ...
    def test_case_5(self):
        self.assertEqual(program.threeNumberSum([12, 3, 1, 2, -6, 5, 0, -8, -1], 0),
                         [[-8, 3, 5], [-6, 1, 5], [-1, 0, 1]])

    def test_case_6(self):
        self.assertEqual(program.threeNumberSum([12, 3, 1, 2, -6, 5, 0, -8, -1, 6], 0),
                         [[-8, 2, 6], [-8, 3, 5], [-6, 0, 6], [-6, 1, 5], [-1, 0, 1]])

    def test_case_7(self):
        self.assertEqual(program.threeNumberSum([12, 3, 1, 2, -6, 5, 0, -8, -1, 6, -5], 0),
                         [[-8, 2, 6], [-8, 3, 5], [-6, 0, 6], [-6, 1, 5], [-5, -1, 6], [-5, 0, 5], [-5, 2, 3],
                          [-1, 0, 1]])

    def test_case_8(self):
        self.assertEqual(program.threeNumberSum([1, 2, 3, 4, 5, 6, 7, 8, 9, 15], 18),
